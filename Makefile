...
OUTPUT_FILE_NAME=GuiMultithreading$(FILE_SUFFIX).exe
...
CFLAGS+=-Wno-dollar-in-identifier-extension -Wno-language-extension-token -Wno-cast-function-type
...
LDLIBS+=-ladvapi32 -lkernel32 -lmsvcrt -lmswsock -loleaut32
LDLIBS+=-lole32 -lshell32 -lshlwapi -lws2_32 -luser32 -lcomctl32 -lgdi32
